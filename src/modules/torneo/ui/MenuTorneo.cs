...
public class MenuTorneo
{
  ...
  private readonly string[] opcionesMenuTorneo =
  {
    "[CRUD] Crear torneo",
    "[CRUD] Actualizar torneo",
    "[CRUD] Eliminar torneo",
    "[LISTAR] Mostrar todos los torneos",
    "[BUSCAR] Buscar por ID",
    "[BUSCAR] Buscar por nombre",
    "[RELACIÓN] Asignar equipo",
    "[RELACIÓN] Quitar equipo",
  ...
  public async Task EjecutarMenu()
  {
    ...
    do
    {
      DibujarMenu("MENÚ TORNEO", opcionesMenuTorneo, opcionSeleccionada);
      ...
      switch (tecla_input.Key)
      {
        ...
        case ConsoleKey.UpArrow:
          ...
          if (opcionSeleccionada < 0) opcionSeleccionada = opcionesMenuTorneo.Length - 1;
          break;
        ...
        case ConsoleKey.DownArrow:
          ...
          if (opcionSeleccionada >= opcionesMenuTorneo.Length) opcionSeleccionada = 0;
          break;
