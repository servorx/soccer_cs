...
public class MenuCuerpoTecnico
{
  ...
  private readonly string[] opcionesMenuCuerpoTecnico =
  {
    "[CRUD] Crear cuerpo técnico",
    "[CRUD] Actualizar cuerpo técnico",
    "[CRUD] Eliminar cuerpo técnico",
    "[LISTAR] Mostrar todos los cuerpos técnicos",
  ...
  public async Task EjecutarMenu()
  {
    ...
    do
    {
      DibujarMenu("MENÚ CUERPO TECNICO", opcionesMenuCuerpoTecnico, opcionSeleccionada);
      ...
      switch (tecla_input.Key)
      {
        ...
        case ConsoleKey.UpArrow:
          ...
          if (opcionSeleccionada < 0) opcionSeleccionada = opcionesMenuCuerpoTecnico.Length - 1;
          break;
        ...
        case ConsoleKey.DownArrow:
          ...
          if (opcionSeleccionada >= opcionesMenuCuerpoTecnico.Length) opcionSeleccionada = 0;
          break;
